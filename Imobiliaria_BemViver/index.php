                        ...
                        <form id="contact" method="post" class="form" role="form">
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-md-9 form-group">
                                    ...
                                    <input type="text" class="form-control" min="10" max="10" name="cpf" id="cpf" required>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-md-9 form-group">
                                        ...
                                        <input type="text" class="form-control" min="11" max="11" name="celular" id="celular" required>
                                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12 col-md-12 form-group">
                                <input type="hidden" class="form-control" name="form_user" value="cadastro_usuario">
                                <a href="consulta_cliente.php" type="submit" class="btn btn-warning">ALTERAR/EXCLUIR</a>
                              </div>
                            </div>
                        </form>
